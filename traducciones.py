TRADUCCIONES = {
    'es': {
        ...
        'coment':          "Cómo funciona la solución\n\n"
                            "- Si tu cubo no tiene ninguna ficha mal colocada, buscamos directamente la secuencia de giros.\n"
                            "- Si detectamos una pieza desorientada, forzamos las piezas para que concuerden con una opción correcta, y generamos la solución desde esa situación.\n\n"
        ...
        'not_found':       '¡Ups! No se ha encontrado el movimiento. Es posible que haya piezas mal colocadas.',
        'question_orbit':  '¿Deseas continuar o corregir el cubo?',
        'continue_orbit':  'Continuar',
        'correct_cube':    'Corregir el cubo',
        'dontknow':        'No sé cuál flipeé',
        'arista_flipped':    'Arista flipeada',
        'pieces_transmuted': 'Casillas intercambiadas',
    ...
    'en': {
        ...
        'coment':          "How the solution works\n\n"
                            "- If your cube has no misoriented pieces, we directly find the sequence of twists.\n"
                            "- If we detect a flipped piece, we force the pieces to match a correct option, and generate the solution from that state."
        ...
        'not_found':       'Oops! The move was not found. It’s possible that some pieces are misaligned.',
        'question_orbit':  'Do you wish to continue or correct the cube?',
        'continue_orbit':  'Continue',
        'correct_cube':    'Correct the Cube',
        'dontknow':        "I don’t know which one I flipped",  
        'arista_flipped':  'Edge flipped',
        'pieces_transmuted': 'Pieces Transmuted',
    ...
    'it': {
        ...
        'coment':          "Come funziona la soluzione\n\n"
                            "- Se il tuo cubo non ha pezzi posizionati male, cerchiamo direttamente la sequenza di mosse.\n"
                            "- Se rileviamo un pezzo disorientato, forziamo i pezzi in modo che corrispondano a un’opzione corretta e generiamo la soluzione da quello stato."
        ...
        'not_found':       "Oops! Mossa non trovata. È possibile che alcuni pezzi siano fuori posto.",
        'question_orbit':  "Vuoi continuare o correggere il cubo?",
        'continue_orbit':  "Continua",
        'correct_cube':    'Correggi il cubo',
        'dontknow':        'Non so quale ho invertito',
        'arista_flipped':  'Arista invertita',
        'pieces_transmuted': 'Pezzi trasmutati',
    ...
    'de': {
        ...
        'coment':          "Funktionsweise der Lösung\n\n"
                            "- Wenn dein Würfel keine fehlplatzieren Steine hat, suchen wir direkt die Abfolge der Drehungen.\n"
                            "- Wenn wir ein falsch orientiertes Teil feststellen, zwingen wir die Teile, einer korrekten Option zu entsprechen, und erstellen die Lösung aus diesem Zustand.\n"
        ...
        'not_found':       'Ups! Der Zug wurde nicht gefunden. Es ist möglich, dass einige Teile falsch positioniert sind.',
        'question_orbit':  'Möchtest du fortfahren oder den Würfel korrigieren?',
        'continue_orbit':  'Weiter',
        'correct_cube':    'Würfel korrigieren',
        'dontknow':        'Ich weiß nicht, welches ich gedreht habe',
        'arista_flipped':  'Kante umgedreht',
        'pieces_transmuted': 'Die Kanten wurden transmutiert',
    ...
    'fr': {
        ...
        'coment':          "Comment fonctionne la solution\n\n"
                            "- Si votre cube n’a aucune pièce mal placée, nous recherchons directement la séquence de rotations.\n"
                            "- Si nous détectons une pièce mal orientée, nous forçons les pièces à correspondre à une option correcte, puis générons la solution à partir de cet état.\n\n"
        ...
        'not_found':       'Oups ! Mouvement non trouvé. Il est possible que des pièces soient mal positionnées.',
        'question_orbit':  'Voulez-vous continuer ou corriger le cube ?',
        'continue_orbit':  'Continuer',
        'correct_cube':    'Corriger le cube',
        'dontknow':        "Je ne sais pas lequel j'ai retourné",
        'arista_flipped':  'Arête inversée',
        'pieces_transmuted': 'Les arêtes ont été transmutées',
